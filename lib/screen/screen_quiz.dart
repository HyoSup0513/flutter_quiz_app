...
class _QuizScreenState extends State<QuizScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Column(children: _buildCandidate(width, quiz),),
          Container(
            ...
            child: Center(
              ...
              child: RaisedButton(child: _currentIndex == widget.quizs.length - 1 ? Text ("See result") : Text("Next question"),
  ...
  List<Widget> _buildCandidate(double width, Quiz quiz) {
